	...
	<ul>
		<?php foreach ($this->entity->children as $cur_child) {
			if (!isset($cur_child) || !$cur_child->enabled)
				continue;
			?>
		<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $cur_child->alias))); ?>"><?php e($cur_child->name); ?></a></li>
		<?php } ?>
	</ul>
</div>
...
<div class="com_storefront_paginate">
	...
	<div style="float: left; margin: 1em 1em 1em 0;" class="pagination">
		<ul>
			...
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => 1, 'sort' => $this->sort))); ?>">&#8676;</a></li>
			<?php } ?>
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page - 1, 'sort' => $this->sort))); ?>">&larr;</a></li>
			<?php } if ($this->page - 2 >= 1) {
				if ($this->page - 2 > 1) { ?>
			<li class="disabled"><a href="javascript:void(0);">&hellip;</a></li>
				<?php } ?>
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page - 2, 'sort' => $this->sort))); ?>"><?php echo $this->page - 2; ?></a></li>
			<?php } if ($this->page - 1 >= 1) { ?>
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page - 1, 'sort' => $this->sort))); ?>"><?php echo $this->page - 1; ?></a></li>
			<?php } ?>
			...
			<?php if ($this->page + 1 <= $pages) { ?>
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page + 1, 'sort' => $this->sort))); ?>">&rarr;</a></li>
			<?php if ($this->page + 1 != $pages) { ?>
			<li><a href="<?php e(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $pages, 'sort' => $this->sort))); ?>">&#8677;</a></li>
			<?php } } ?>
		</ul>
	</div>
	<?php } ?>
	<div style="float: right; margin: 1em 0 1em 1em;">
		...
		Sorted by <select class="form-control" name="sort" onchange="$_.get(<?php e(json_encode(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page)))); ?>, {sort: $(this).val()})">
