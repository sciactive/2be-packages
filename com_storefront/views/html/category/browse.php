...
<div class="com_storefront_paginate">
	...
	<div style="float: right; margin: 1em 0 1em 1em;">
		...
		Sorted by <select name="sort" onchange="pines.get(<?php e(json_encode(pines_url('com_storefront', 'category/browse', array('a' => $this->entity->alias, 'page' => $this->page)))); ?>, {sort: $(this).val()})">
