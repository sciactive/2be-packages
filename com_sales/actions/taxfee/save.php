...
$test = $_->entity_manager->get_entity(array('class' => com_sales_tax_fee, 'skip_ac' => true), array('&', 'tag' => array('com_sales', 'tax_fee'), 'data' => array('name', $tax_fee->name)));
...
if ($_->config->com_sales->global_tax_fees)
	$tax_fee->ac->other = 1;
