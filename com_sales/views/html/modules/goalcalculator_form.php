...
<div class="pf-form">
	<div class="pf-element">
		<label><span class="pf-label">Goals</span>
			...
			<input class="pf-field" type="text" name="goals" size="36" value="<?php e(!$this->goals ? '20, 30, 60, 80' : $this->goals); ?>" /></label>
	</div>
	<div class="pf-element">
		...
		<div class="pf-group">
			<div class="input-append">
				<input id="p_muid_yellow" style="position: inherit;" class="pf-field" type="text" name="yellow_multiplier" size="3" value="<?php e(!$this->yellow_multiplier ? '80' : $this->yellow_multiplier); ?>" /><span class="add-on">%</span>
			</div>
		</div>
	</div>
</div>