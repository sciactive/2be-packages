...
<form class="pf-form" id="p_muid_form" action="">
	...
	<div class="pf-element">
		<label><span class="pf-label">Override User</span>
			<input class="pf-field form-control salesperson_box" type="text" name="user" value="<?php echo isset($this->entity->user->guid) ? h("{$this->entity->user->guid}: {$this->entity->user->name}") : ''; ?>" /></label>
	</div>
	<div class="pf-element pf-heading">
		<h3>Location</h3>
	</div>
