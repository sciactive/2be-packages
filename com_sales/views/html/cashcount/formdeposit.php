...
$this->title = 'Deposit from Cash Count ['.h($this->entity->cashcount->guid).'] at '.h($this->entity->cashcount->group->name);
...
<script type="text/javascript">
	$_(function(){
		...
		var update_total = function(){
			...
			$("#p_muid_total_deposit").html($_.safe(cash_symbol+total_count.toFixed(2)));
		};
...
<form class="pf-form" method="post" id="p_muid_form" action="<?php e(pines_url('com_sales', 'cashcount/savedeposit')); ?>">
