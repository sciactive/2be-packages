...
$this->title = 'Auditing Cash Count ['.h($this->entity->cashcount->guid).'] for '.h($this->entity->cashcount->group->name);
...
<script type="text/javascript">
	$_(function(){
		...
		var update_total = function(){
			...
			$("#p_muid_total_audit").html($_.safe(cash_symbol+total_count.toFixed(2)));
		};
...
<form class="pf-form" method="post" id="p_muid_form" action="<?php e(pines_url('com_sales', 'cashcount/saveaudit')); ?>">
	...
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button btn btn-primary" type="button" value="Finish Audit" onclick="$_.com_sales_verify();" />
