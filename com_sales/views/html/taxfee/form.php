...
<form class="pf-form" method="post" action="<?php e(pines_url('com_sales', 'taxfee/save')); ?>">
	...
	<div class="pf-element">
		<label>
			...
			<input class="pf-field form-control" type="text" name="name" size="24" value="<?php e($this->entity->name); ?>" />
		</label>
	</div>
	<div class="pf-element">
		<label>
	...
	<div class="pf-element">
		<label>
			...
			<select class="pf-field form-control" name="type">
	...
	<div class="pf-element">
		<label>
			...
			<input class="pf-field form-control" type="text" name="rate" size="24" value="<?php e($this->entity->rate); ?>" />
		</label>
	</div>
	<div class="pf-element">
		<label>
			...
			<select class="pf-field form-control" name="locations[]" multiple="multiple" size="6">
				<?php
	...
	<div class="pf-element pf-buttons">
		...
		<input class="pf-button btn btn-default" type="button" onclick="$_.get(<?php e(json_encode(pines_url('com_sales', 'taxfee/list'))); ?>);" value="Cancel" />
	</div>
</form>