...
<form class="pf-form" id="p_muid_form" action="">
	...
	<div class="timespan">
		<div class="pf-element">
			<span class="pf-note">Start</span><input class="form_date form-control" type="text" id="p_muid_start_date" name="start_date" value="<?php echo isset($this->start_date) ? h($this->start_date) : ''; ?>" />
		</div>
		<div class="pf-element">
			<span class="pf-note">End</span><input class="form_date form-control" type="text" id="p_muid_end_date" name="end_date" value="<?php echo isset($this->end_date) ? h($this->end_date) : ''; ?>" />
		</div>
		<input type="hidden" name="timespan_saver" value="<?php e($this->all_time); ?>" />
	</div>
</form>