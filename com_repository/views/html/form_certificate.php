...
<form class="pf-form" method="post" action="<?php e(pines_url('com_repository', 'savecert')); ?>">
	<div class="pf-element">
		<label><span class="pf-label">Country Name</span>
			...
			<input class="pf-field form-control" type="text" name="countryName" size="24" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">State or Province Name</span>
			<span class="pf-note">Full Name (Ex: Some-State)</span>
			<input class="pf-field form-control" type="text" name="stateOrProvinceName" size="24" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Locality</span>
			<span class="pf-note">Eg, City (Ex: City)</span>
			<input class="pf-field form-control" type="text" name="localityName" size="24" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Organization Name</span>
			<span class="pf-note">Eg, Company (Ex: Internet Widgits Pty Ltd)</span>
			<input class="pf-field form-control" type="text" name="organizationName" size="24" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Organizational Unit Name</span>
			<span class="pf-note">Eg, Section (Ex: Dev Repository)</span>
			<input class="pf-field form-control" type="text" name="organizationalUnitName" size="24" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Common Name</span>
			<span class="pf-note">Eg, The Repository (Ex: http://2be.example.com/repo/)</span>
			<input class="pf-field form-control" type="text" name="commonName" size="24" value="<?php e($_->config->full_location); ?>" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Email Address</span>
			<input class="pf-field form-control" type="email" name="emailAddress" size="24" /></label>
	</div>
	...
	<div class="pf-element">
		<label><span class="pf-label">Digest Method</span>
			...
			<select class="pf-field form-control" name="digest_alg">
	...
	<div class="pf-element">
		<label><span class="pf-label">Private Key Bits</span>
			<input class="pf-field form-control" type="text" name="private_key_bits" size="24" value="1024" /></label>
	</div>
	<div class="pf-element">
		<label><span class="pf-label">Valid Days</span>
			<input class="pf-field form-control" type="text" name="days" size="24" value="365" /></label>
	</div>
	<div class="pf-element">
