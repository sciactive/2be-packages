	...
	<div id="p_muid_manual_form" style="display: none;">
		<div class="pf-element">
			<label><span class="pf-label">Cardholder First Name</span>
				<input class="pf-field" type="text" id="p_muid_name_first" name="name_first" value="<?php e($this->name_first); ?>" /></label>
		</div>
		<div class="pf-element">
			<label><span class="pf-label">Cardholder Last Name</span>
				<input class="pf-field" type="text" id="p_muid_name_last" name="name_last" value="<?php e($this->name_last); ?>" /></label>
		</div>
		<div class="pf-element">
			<label><span class="pf-label">Card Number</span>
				<input class="pf-field" type="text" id="p_muid_card_number" name="card_number" value="<?php e($this->card_number); ?>" /></label>
		</div>
		<div class="pf-element">
			...
			<input class="pf-field" type="password" name="cid" size="3" value="<?php e($this->cid); ?>" />
		</div>
	</div>
