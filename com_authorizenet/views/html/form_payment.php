	...
	<div id="p_muid_swipe_form">
		<div class="pf-element">
			<label><span class="pf-label">Swipe Card</span>
				<input class="pf-field form-control" type="password" id="p_muid_card_swipe" name="card_swipe" value="" /></label>
		</div>
		<div class="pf-element">
			<div class="pf-group">
				<button class="pf-field btn btn-default" type="button" onclick="
	...
	<div id="p_muid_manual_form" style="display: none;">
		<div class="pf-element">
			<label><span class="pf-label">Cardholder First Name</span>
				<input class="pf-field form-control" type="text" id="p_muid_name_first" name="name_first" value="<?php e($this->name_first); ?>" /></label>
		</div>
		<div class="pf-element">
			<label><span class="pf-label">Cardholder Last Name</span>
				<input class="pf-field form-control" type="text" id="p_muid_name_last" name="name_last" value="<?php e($this->name_last); ?>" /></label>
		</div>
		<div class="pf-element">
			<label><span class="pf-label">Card Number</span>
				<input class="pf-field form-control" type="text" id="p_muid_card_number" name="card_number" value="<?php e($this->card_number); ?>" /></label>
		</div>
		<div class="pf-element">
			<span class="pf-label">Expiration Date, CCV</span>
			<select class="pf-field form-control" id="p_muid_card_exp_month" name="card_exp_month">
				<?php foreach (array(
						'01' => '01 January',
						'02' => '02 February',
						'03' => '03 March',
			...
			<select class="pf-field form-control" id="p_muid_card_exp_year" name="card_exp_year">
				<?php for ($i = 0; $i <= 25; $i++) { ?>
			...
			<input class="pf-field form-control" type="password" name="cid" size="3" value="<?php e($this->cid); ?>" />
		</div>
	</div>
