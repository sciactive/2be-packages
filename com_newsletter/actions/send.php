...
if ( $_REQUEST['include_permalink'] == 'on' ) {
	...
	$message = "<div style=\"text-align: center; font-size: smaller;\">Having trouble reading this message? <a href=\"".h(pines_url('com_newsletter', 'webview', array('mail_id' => $mail_id), true))."\" target=\"_blank\">Click here</a> to view this message in your browser.</div>" . $message;
}

$location = group::factory((int) $_REQUEST['location']);
if (isset($location->guid)) {
	$addresses = array();
	$group_users = $_->nymph->getEntities(array('class' => user), array('&', 'tag' => array('com_user', 'user')));
