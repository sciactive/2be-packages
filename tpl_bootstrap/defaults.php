...
return array(
	...
	array(
        ...
        array(
		'name' => 'link_css',
		'cname' => 'Link WonderPHP Relative CSS List',
	...
	array(
		'name' => 'load_css1',
		'cname' => 'JS Load WonderPHP Relative CSS 1',
		'description' => 'You can add a WonderPHP relative style sheet to always load with this template. Uses JavaScript loading. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css2',
		'cname' => 'JS Load WonderPHP Relative CSS 2',
		'description' => 'You can add a WonderPHP relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css3',
		'cname' => 'JS Load WonderPHP Relative CSS 3',
		'description' => 'You can add a WonderPHP relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css4',
		'cname' => 'JS Load WonderPHP Relative CSS 4',
		'description' => 'You can add a WonderPHP relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js1',
		'cname' => 'Load WonderPHP Relative JS 1',
		'description' => 'You can add a WonderPHP relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js2',
		'cname' => 'Load WonderPHP Relative JS 2',
		'description' => 'You can add a WonderPHP relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js3',
		'cname' => 'Load WonderPHP Relative JS 3',
		'description' => 'You can add a WonderPHP relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js4',
		'cname' => 'Load WonderPHP Relative JS 4',
		'description' => 'You can add a WonderPHP relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
