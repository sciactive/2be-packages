...
return array(
	...
	array(
        ...
        array(
		'name' => 'link_css',
		'cname' => 'Link 2be Relative CSS List',
	...
	array(
		'name' => 'load_css1',
		'cname' => 'JS Load 2be Relative CSS 1',
		'description' => 'You can add a 2be relative style sheet to always load with this template. Uses JavaScript loading. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css2',
		'cname' => 'JS Load 2be Relative CSS 2',
		'description' => 'You can add a 2be relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css3',
		'cname' => 'JS Load 2be Relative CSS 3',
		'description' => 'You can add a 2be relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_css4',
		'cname' => 'JS Load 2be Relative CSS 4',
		'description' => 'You can add a 2be relative style sheet to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js1',
		'cname' => 'Load 2be Relative JS 1',
		'description' => 'You can add a 2be relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
	array(
		'name' => 'load_js2',
		'cname' => 'Load 2be Relative JS 2',
		'description' => 'You can add a 2be relative javascript file to always load with this template. Write the file starting with components/component_name/includes/...',
		'value' => '',
		'peruser' => true,
	),
