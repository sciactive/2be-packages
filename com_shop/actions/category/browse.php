...
//$module = new module('com_shop', 'category/specs', 'left');
//$module->entity = $entity;

$module = new module('com_shop', 'category/browse', 'content');
$module->entity = $entity;
...
$module->products_per_page = $_->config->com_shop->products_per_page;
