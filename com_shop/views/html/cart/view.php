...
<div>
	...
	<br />
	<div style="padding: .5em;">Subtotal <small>(before tax/fees)</small><div style="float: right; text-align: right;"><?php echo $_->com_shop->format_price($subtotal, 'long'); ?></div></div>
	<br style="clear: both;" /><br />
	<button type="button" class="checkout btn btn-primary" style="float: right; clear: right;" onclick="$_.get(<?php e(json_encode(pines_url('com_shop', 'checkout/login'))); ?>);">Check-Out</button>
