...
$_.loadcss("<?php e($_->config->location); ?>components/com_pform/includes/<?php echo $_->config->debug_mode ? 'pform.css' : 'pform.min.css'; ?>");
<?php if ($_->depend->check('component', 'com_bootstrap')) { ?>
$_.loadcss("<?php e($_->config->location); ?>components/com_pform/includes/<?php echo $_->config->debug_mode ? 'pform-bootstrap.css' : 'pform-bootstrap.min.css'; ?>");
<?php } ?></script>
<noscript>
...
<!--[if lt IE 8]>
<script type="text/javascript">
$_.loadcss("<?php e($_->config->location); ?>components/com_pform/includes/<?php echo $_->config->debug_mode ? 'pform-ie-lt-8.css' : 'pform-ie-lt-8.min.css'; ?>");</script>
<noscript>
...
<!--[if lt IE 6]>
<script type="text/javascript">
$_.loadcss("<?php e($_->config->location); ?>components/com_pform/includes/<?php echo $_->config->debug_mode ? 'pform-ie-lt-6.css' : 'pform-ie-lt-6.min.css'; ?>");</script>
<![endif]-->