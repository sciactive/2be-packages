...
<script type="text/javascript" src="<?php e($pines->config->location); ?>templates/tpl_bootstrap/js/<?php echo ($pines->config->debug_mode) ? 'template' : 'template.min'; ?>.js"></script>
