...
<div class="pf-form">
	...
	<div class="pf-element pf-full-width">
		<div class="pf-label" style="width:280px;margin-right:60px;">
			...
			<span>First Payment: <span style="float:right;"><?php e(format_date($this->entity->first_payment_date, "date_short")); ?></span></span><br/>
	...
	<div class="pf-element pf-buttons">
		<form class="pf-form" method="post" id="p_muid_loan_form" action="<?php e(pines_url('com_loan', 'loan/save')); ?>">
			<input type="hidden" name="customer" value="<?php e($this->entity->customer->guid); ?>" />
			<input type="hidden" name="creation_date" value="<?php e(format_date($this->entity->creation_date, "date_sort")); ?>" />
			<input type="hidden" name="principal" value="<?php e($this->entity->principal); ?>" />
			<input type="hidden" name="apr" value="<?php e($this->entity->apr); ?>" />
			<input type="hidden" name="apr_correct" value="ON" />
			<input type="hidden" name="term" value="<?php e($this->entity->term); ?>" />
			<input type="hidden" name="term_type" value="<?php e($this->entity->term_type); ?>" />
			<input type="hidden" name="first_payment_date" value="<?php e(format_date($this->entity->first_payment_date, "date_sort")); ?>" />
			<input type="hidden" name="payment_frequency" value="<?php e($this->entity->payment_frequency); ?>" />
			<input type="hidden" name="compound_frequency" value="<?php e($this->entity->compound_frequency); ?>" />
