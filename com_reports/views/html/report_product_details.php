...
$this->title = 'Product Details Report ['.h($this->location->name).']';
if (!$this->all_time)
...
<script type="text/javascript">
	$_(function(){
		$_.search_details = function(){
			...
			$_.get(<?php echo json_encode(pines_url('com_reports', 'reportproducts')); ?>, {
				"location": location,
	...
	<tbody>
		...
		foreach ($this->transactions as $cur_tx) {
			...
			<tr <?php echo $class; ?>>
				...
				<td><a data-entity="<?php e($cur_item['salesperson']->guid); ?>" data-entity-context="user"><?php e($cur_item['salesperson']->name); ?></a></td>
